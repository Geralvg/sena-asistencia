...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($environment->create($name, $center_id)) {
        $success_message = "Ambiente creado exitosamente.";
    } else {
        $error_message = "Error al crear el ambiente.";
    }
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Crear Ambiente - SENA Asistencias</title>
...
<body class="bg-gradient-to-r from-blue-50 to-purple-50 min-h-screen">
    ...
    <div class="container mx-auto p-6">
        <div class="bg-white rounded-xl shadow-lg p-8 max-w-md mx-auto">
            <h2 class="text-2xl font-bold mb-6 text-center">Crear Ambiente</h2>
            <form method="POST" onsubmit="showModal('Ambiente creado exitosamente.')">
                <div class="mb-4">
                    <label class="block text-gray-700">Nombre del Ambiente</label>
